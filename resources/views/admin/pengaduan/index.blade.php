...
@section('content')
    <div class="container">
        ...
        <!-- Form Pencarian -->
        <form class="mb-4" action="{{ route('admin.pengaduan.index') }}" method="GET">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="{{ route('admin.pengaduan.show', $pengaduan->id) }}"
                                class="btn btn-secondary btn-sm "><i class="bi bi-eye"></i> Lihat
                                Selengkapnya</a>
        ...
        <div class="card mt-4 shadow-lg border-0 rounded-lg">
            ...
            <div class="card-body">
                <form action="{{ route('admin.testimoni.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="testimoni" class="form-label"><i class="bi bi-chat-left-quote-fill"></i>
                            Testimoni</label>
